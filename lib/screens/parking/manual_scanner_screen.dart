        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                  padding: const EdgeInsets.only(left: 20, right: 20, top: 10), child: ButtonSecondary(title: 'Buscar Boleto', function: _goPayment)),
            ],
          ),
        ));
  }
  ...
  void _goPayment() {
    if (codigoController.text.isNotEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Proporciona el código del boleto')),
      );
    }
  }
}
